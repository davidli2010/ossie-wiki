---
title: "Apache Ossie 表达式语言规范 proposal (OSSIE_SQL_2026)"
source: "https://github.com/apache/ossie/tree/main/core-spec/expression_language.md"
author:
  - "[[Apache Software Foundation]]"
published: 2026-08-14
created: 2026-08-14
description: "Ossie SQL 表达式语言提案：可移植表达式子集、聚合/日期/字符串/数学/条件/窗口/类型转换函数、方言扩展与合规级别。"
tags:
  - "ossie"
  - "expression-language"
  - "spec"
...
> 抓取时间：2026-08-14（main 分支）。原始文件含 ASF License header。
